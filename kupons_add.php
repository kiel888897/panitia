...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($exists > 0) {
        ...
        // 💾 Simpan data baru
        $stmt = $pdo->prepare("
            INSERT INTO kupon (nama, nomor_kupon, jumlah, kembali, created_at)
            VALUES (?, ?, ?, ?, NOW())
        ");
        $stmt->execute([$nama, $nomor_kupon, $jumlah, $kembali]);


        header('Location: kupon.php?added=1');
        exit;
    }
}
?>
        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Add New Kupon</h3>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="kupon.php">Kupon</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Add Kupon</li>
                            </ol>
                        </div>
                    </div>
                    <!--end::Row-->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="nomor_kupon" name="nomor_kupon" rows="3"
                                                class="form-control" placeholder="Masukkan daftar nomor kupon, pisahkan dengan koma" required></textarea>
