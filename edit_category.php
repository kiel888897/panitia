...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_FILES['photo']['name'])) {
        ...
        $target_directory = 'uploads/categorys/'; // Folder untuk simpan foto
        ...
        $photo_filename = $category['photo']; // Tetap gunakan foto lama
    }
    if ($name) {
        $stmt = $pdo->prepare("UPDATE category SET name = ?, photo = ?, status = ? WHERE id = ?");
        $stmt->execute([$name, $photo_filename, $status, $id]);
        header('Location: category_menu.php');
        exit;
    } else {
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                ...
                                <li class="breadcrumb-item"><a href="category_menu.php">Category Menu</a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary card-outline mb-4">
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="name" class="form-label">Category Menu</label>
                                            <input
                                                type="text" class="form-control" name="name" id="name" aria-describedby="name" value="<?= htmlspecialchars($category['name']) ?>" required />
                                        </div>
                                        ...
                                        <?php if (!empty($category['photo'])): ?>
                                            <div class="mb-3">
                                                <img src="uploads/categorys/<?= htmlspecialchars($category['photo']) ?>" alt="<?= htmlspecialchars($category['name']) ?>" style="max-width: 200px; height: auto;">
                                            </div>
                                        <?php endif; ?>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="category_menu.php" class="float-end btn btn-secondary">Back</a>
                                    </div>
                                    <!--end::Footer-->
                                </form>
                                <!--end::Form-->
