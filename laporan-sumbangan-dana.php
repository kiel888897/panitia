...
$stmt = $pdo->prepare("SELECT * FROM sumbangan WHERE jenis = 'dana' ORDER BY tanggal DESC");
$stmt->execute();
...
<head>
    <meta charset="utf-8">
    <title>Laporan Sumbangan Dana | Panitia</title>
    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title"><i class="bi bi-download"></i> Export Data Sumbangan Dana</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body p-0" style="height: 30vh;">
                <iframe src="export_sumbangan_dana.php" style="width:100%;height:100%;border:none;"></iframe>
            </div>
        </div>
    </div>
</div>
        ...
        <main class="app-main">
            <div class="app-content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Laporan Sumbangan Dana</h3>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active">Laporan Sumbangan Dana</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php if (empty($data)): ?>
                                <div class="alert alert-info">Belum ada data sumbangan Dana.</div>
                            <?php else: ?>
                                    ...
                                    <table id="lapTable" class="table table-bordered table-striped align-middle">
                                        ...
                                        <tfoot class="table-light">
                                            <tr>
                                                ...
                                                <th colspan="4">Rp <?= number_format($total_jumlah, 0, ',', '.'); ?></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
