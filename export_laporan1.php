...
<body class="p-4">
    <div class="container-fluid">
        <div class="page-keep-together mb-4">
            ...
            <?php
            echo "<h4 class='mt-3'>Rekap Laporan Pemasukan dan Laporan Pengeluaran dana</h4>";
            ?>
        </div>
        <?php
    ...
    <?= $saldoAkhir >= 0 ? 'bg-success text-white' : 'bg-danger text-white' ?>">
            ...
            <div class="row text-center mt-3">
                <div class="col-md-6">
                    ...
                    <div>Rp <?= number_format($totalPemasukan, 0, ',', '.') ?></div>
                </div>
                <div class="col-md-6">
                    <div class="fw-bold">Total Pengeluaran</div>
                    <div>Rp <?= number_format($totalPengeluaran, 0, ',', '.') ?></div>
                </div>
            </div>
        </div>
...
<tr class='table-light fw-bold'>
  ...
  <td class='text-end'>Rp " . number_format($totalPiutang, 0, ',', '.') . "</td>
    ...
    ");
        ...
        echo "<h4 class='section-title'>{$judulPengeluaran}</h4>";
