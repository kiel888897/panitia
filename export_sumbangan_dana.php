...
// Ambil semua data sumbangan dana
$stmt = $pdo->query("
...
<head>
    <meta charset="UTF-8" />
    <title>Export Sumbangan Dana | Panitia PTS</title>
...
<body class="p-4 text-center">
    <h3 class="mb-3">Export Data Dana</h3>
    <div class="mb-3">
    ...
    <script>
        ...
        document.getElementById('exportExcel').addEventListener('click', () => {
            ...
            const aoa = [];
            aoa.push(['Laporan Sumbangan Dana']);
            ...
            XLSX.utils.book_append_sheet(wb, ws, 'Sumbangan Dana');
            XLSX.writeFile(wb, `laporan_sumbangan_dana_${tanggal}.xlsx`);
        });
        ...
        document.getElementById('exportPDF').addEventListener('click', () => {
            ...
            pdfMake.createPdf(docDefinition).download(`laporan_sumbangan_dana_${tanggal}.pdf`);
        });
    </script>
</body>
