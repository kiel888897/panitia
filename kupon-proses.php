...
$stmt = $pdo->query("
    SELECT
        ...
        bk.bayar,
        bk.bukti,
        bk.created_at AS bayar_created,
        k.nama,
        k.nomor_kupon,
        k.jumlah AS kupon_jumlah,
        k.kembali AS kupon_kembali,
        k.created_at AS kupon_created
    FROM bayar_kupon bk
    JOIN kupon k ON bk.id_kupon = k.id
    ORDER BY bk.tanggal DESC
");
$bayar_kupon = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<!doctype html>
<html lang="en">
<!--begin::Head-->
        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Pembayaran Kupon PTS</h3>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Pembayaran Kupon PTS</li>
                            </ol>
                        </div>
                    </div>
                    <!--end::Row-->
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="kupon_add.php" class="btn btn-success mb-3"><i class="bi bi-plus-circle"></i> Tambah Pembayaran</a>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($bayar_kupon as $row): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="kupon_edit.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">✏️</a>
                                                        <a href="kupon_delete.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus data ini?')">🗑️</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
