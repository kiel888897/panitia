...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($title && $day) {
        ...
        $error = 'Please fill in all required fields (Title and Day).';
    }
}
?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                ...
                                <li class="breadcrumb-item"><a href="events.php">Restaurants</a></li>
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input
                                                type="text" class="form-control" name="title" id="title" aria-describedby="title" required />
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div class="invalid-feedback">Please select a valid Day Type.</div>
                                        </div>
                                        <div class="mb-3">
