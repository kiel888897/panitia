...
$seksiNamaMap = [
    'lapacara' => 'Acara',
    'lapkonsumsi' => 'Konsumsi',
    'lapperlengkapan' => 'Perlengkapan'
];

// Ambil seksi dari menu
$filterSeksi = isset($seksiMap[$menu]) ? $seksiMap[$menu] : null;
$namaSeksi   = isset($seksiNamaMap[$menu]) ? $seksiNamaMap[$menu] : null;
    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body p-0" style="height: 30vh;">
                <!-- <iframe src="export_pengeluaran.php" style="width: 100%; height: 100%; border: none;"></iframe> -->

                <?php
                $iframeSrc = 'export_pengeluaran.php';
                if (!empty($filterSeksi)) {
                    $iframeSrc .= '?seksi=' . (int)$filterSeksi;
                }
                ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                ...
                                <li class="breadcrumb-item active">Laporan Pengeluaran PTS</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php if (!empty($row['nota'])): ?>
                                                        <a href="uploads/<?= htmlspecialchars($row['nota']) ?>" target="_blank">
                                                            Lihat Nota
                                                        </a>
                                                    <?php else: ?>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <?php if (!empty($row['bayar'])): ?>
                                                        <a href="uploads/<?= htmlspecialchars($row['bayar']) ?>" target="_blank">
