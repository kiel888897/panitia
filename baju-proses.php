...
$stmt = $pdo->query("
    ...
    ORDER BY bb.tanggal DESC
");
$bayar_baju = $stmt->fetchAll(PDO::FETCH_ASSOC);
        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Pembayaran Baju PTS</h3>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Pembayaran Baju PTS</li>
                            </ol>
                        </div>
                    </div>
                    <!--end::Row-->
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="baju_add.php" class="btn btn-success mb-3"><i class="bi bi-plus-circle"></i> Tambah Pembayaran</a>
                                    <table class="table table-bordered" id="bajuTable">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($bayar_baju as $row): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="baju_edit.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">✏️</a>
                                                        <a href="baju_delete.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus data ini?')">🗑️</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
