        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Category Menu Restaurants</h3>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Category Menu Restaurants</li>
                            </ol>
                        </div>
                    </div>
                    <!--end::Row-->
                                    ...
                                    <table class="table table-bordered" id="categoryTable">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($categorys as $category): ?>
                                                <tr>
                                                    <td><?= $i++ ?></td>
                                                    <td><?= htmlspecialchars(ucwords($category['name'])) ?></td>
                                                    <td>
                                                        <img src="uploads/categorys/<?= htmlspecialchars($category['photo']) ?>" alt="<?= htmlspecialchars($category['name']) ?>" style="max-width: 100px; height: auto;">
                                                    </td>
                                                    <td><?= htmlspecialchars(ucwords($category['status'])) ?></td>
                                                    <td>
