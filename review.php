                                    ...
                                    <table class="table table-bordered" id="reviewTable">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($reviews as $review): ?>
                                                <tr>
                                                    <td><?= $i++ ?></td>
                                                    <td><?= htmlspecialchars(ucwords($review['restaurant_name'])) ?></td>
                                                    <td><?= htmlspecialchars(ucwords($review['customer_name'])) ?></td>
                                                    <td><?= htmlspecialchars($review['rating']) ?> ★</td>
                                                    <td><?= nl2br(htmlspecialchars($review['review'])) ?></td>
                                                    <td>
                                                        <?= $review['approved'] ? '<span class="badge bg-success">Approved</span>' : '<span class="badge bg-secondary">Pending</span>' ?>
                                                    </td>
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Actions">
                                                            <?php if (!$review['approved']): ?>
                                                                <a href="approve_review.php?id=<?= $review['id'] ?>" class="btn btn-sm btn-success">Approve</a>
                                                            <?php endif; ?>
                                                            <a href="delete_review.php?id=<?= $review['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure to delete this review?')">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
